...
plot(t,gompd(0.002,1,t),main='            Figure 01
                       Prabability Density Function Of Gompertz Distribution (phi=0.002)')
...
plot(t,cumgomp(0.002,t),main='  Figure 02
                Cumylative Function Of Gompertz Distribution (phi=0.002)')
...
TABLE1 = matrix(c(sample,co1.1,co1.2,co1.3,co2,co3,co4,co5,co6),6)
rownames(TABLE1) = c('n=15  EXP','n=15  MSE','n=50  EXP','n=50  MSE','n=100 EXP','n=100 MSE') 
colnames(TABLE1) = c('Criteria     n','MLE','UMVUE','MSE','Jeffreys prior'
...
# First curve is plotted
 plot(xdata, y1, type="o", col="blue", pch="o", lty=1,ylim=c(0.4,0.6) 
...
# Use symbol '+' for points.
 ...
 legend('top',legend=c('MLE','UMVUE','MSE'),col=c('blue','red','dark red'),lty=c(1,2,3),box.lty=0)
...
# plot the first curve by calling plot() function
# First curve is plotted
 plot(xdata, u1, type="o", col="blue", pch="o", lty=1,ylim=c(0.4,0.6) 
...
# Use symbol 'r' for points.
 ...
 legend('top',legend=c('Jeffreys','Gamma(0.8,0.5)','Gamma(0.8,3.0)'
